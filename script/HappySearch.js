...
function addBox() {
  ...
  div.style =
    'position: fixed; top: 120px; left: 20px; width: 80px; background-color: #EEEEEE; font-size: 12px;z-index: 99999;';
  ...
  title.style =
    'display: block; text-align: center; margin-top: 10px; font-size: 14px; font-weight: bold;';
